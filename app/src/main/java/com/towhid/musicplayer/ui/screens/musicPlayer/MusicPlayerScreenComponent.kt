package com.towhid.musicplayer.ui.screens.musicPlayer
...
import com.towhid.musicplayer.ui.components.RoundImageButton
import com.towhid.musicplayer.ui.utils.MUSIC_NEXT_TAG
import com.towhid.musicplayer.ui.utils.MUSIC_PLAY_PAUSE_TAG
import com.towhid.musicplayer.ui.utils.MUSIC_PREV_TAG
import com.towhid.musicplayer.utils.formatDuration
...
fun MusicPoster(
    ...
    Surface(shadowElevation = 8.dp, shape = RoundedCornerShape(4.dp)) {
        Image(
